...
----
sbt new akka/akka-microservices-scala.g8
----

TODO: this template doesn't exist yet
...
You can use any code editor you prefer for this tutorial. We recommend [IntelliJ](https://www.jetbrains.com/idea/) from JetBrains.
