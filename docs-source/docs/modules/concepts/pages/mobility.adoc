...
- _Load-balancing between instances of a stateless service_: If a service is stateless then it does not matter to which instance a particular request is sent and a wide variety of routing algo‐ rithms can be employed, such as round-robin, broadcast or metrics-based.
