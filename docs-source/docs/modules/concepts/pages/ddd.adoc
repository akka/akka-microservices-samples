...
Both external event-driven modeling and xref:event-sourcing.adoc[] are a perfect match. You can use an <<Anti-Corruption Layer>> and directly publish the Aggregate events for cross-context consumption.
