...
Both Akka and Lagom provide functionality to help you work with events and CQRS. See https://www.lagomframework.com/documentation/current/java/ES_CQRS.html[Managing Data Persistence, window="lagom-cqrs"] and https://www.lagomframework.com/documentation/current/scala/PersistentEntity.html[Persistent Entity, window="lagom-persistent-ent"] in the Lagom documentation and https://doc.akka.io/docs/akka/current/persistence.html[Akka Persistence, window-"akka-persistence"], https://doc.akka.io/docs/akka/current/persistence-query.html[Akka Persistence Query, window="akka-persistence-query"], and https://doc.akka.io/docs/akka/current/cluster-sharding.html[Cluster Sharding, window="cluster-sharding"] in the Akka documentation. Lightbend highly recommends that you take the free, self paced https://cognitiveclass.ai/courses/reactive-architecture-introduction/[Introduction to Reactive Architecture, window="reactive-course"] course.
