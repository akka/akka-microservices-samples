...
****
You can download the initial source for this section link:_attachments/shopping-cart-service-projection.zip[here] +
(includes code from the previous step).

The completed source code for this section can be downloaded link:_attachments/shopping-cart-service-projection-kafka.zip[here].
****
