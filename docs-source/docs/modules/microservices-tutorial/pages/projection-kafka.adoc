...
****
You can download the initial source for this section link:_attachments/4-shopping-cart-projection-scala.zip[here] +
(includes code from the previous step).

The completed source code for this section can be downloaded link:_attachments/5-shopping-cart-projection-kafka-scala.zip[here].
****
