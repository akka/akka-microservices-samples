...
****
You can download the link:_attachments/5-shopping-cart-projection-kafka-scala.zip[initial source] for this tutorial step (includes code from the previous step).

Or if you prefer, you can download the link:_attachments/6-shopping-cart-complete-scala.zip[completed source] for this tutorial step.
****
