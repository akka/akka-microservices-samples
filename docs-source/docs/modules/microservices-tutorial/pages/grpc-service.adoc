...
****
You can download the initial project template link:_attachments/shopping-cart-service-start-scala.zip[here] or use `sbt` to start a new project based on the template as explained in xref:template.adoc[Run the template].

The completed source code for this section can be downloaded link:_attachments/shopping-cart-service-grpc-scala.zip[here].
****
