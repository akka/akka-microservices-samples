...
****
You can download the initial source for this section link:_attachments/1-shopping-cart-grpc-scala.zip[here]. +
(includes code from the previous step)

The completed source code for this section can be downloaded link:_attachments/2-shopping-cart-event-sourced-scala.zip[here].
****
