...
****
You can download the link:_attachments/1-shopping-cart-grpc-scala.zip[initial source] for this tutorial step (includes code from the previous step).

Or, if you prefer, you can download the link:_attachments/2-shopping-cart-event-sourced-scala.zip[completed source] for this tutorial step.
****
