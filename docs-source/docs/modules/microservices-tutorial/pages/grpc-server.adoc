...
[source,java]
----
include::example$shopping-cart-service-java/src/main/java/shopping/cart/ShoppingCartServiceImpl.java[]
----
...
[source,java]
----
include::example$shopping-cart-service-java/src/main/java/shopping/cart/ShoppingCartServer.java[]
----
...
[source,java]
----
include::example$shopping-cart-service-java/src/main/java/shopping/cart/Main.java[]
----
