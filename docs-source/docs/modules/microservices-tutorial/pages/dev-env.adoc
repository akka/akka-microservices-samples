...
If you prefer to skip the tutorial and study the full example implementation on your own, you can download it link:_attachments/6-shopping-cart-complete-scala.zip[here].
