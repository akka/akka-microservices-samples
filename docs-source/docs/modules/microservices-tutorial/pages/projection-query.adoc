...
<1> using https://docs.datastax.com/en/cql-oss/3.x/cql/cql_reference/counter_type.html[counter data type]
...
[source,cql]
----
include::example$shopping-cart-service-scala/ddl-scripts/create_user_tables.cql[tag=itemPopularityTables]
----
