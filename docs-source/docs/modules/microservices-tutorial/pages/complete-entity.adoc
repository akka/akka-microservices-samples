...
****
You can download the link:_attachments/2-shopping-cart-event-sourced-scala.zip[initial source] for this tutorial step (includes code from the previous step).

Or, if you prefer, you can download the link:_attachments/3-shopping-cart-event-sourced-complete-scala.zip[completed source] for this tutorial step.
****
