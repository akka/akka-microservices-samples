...
****
You can download the initial source for this section link:_attachments/2-shopping-cart-event-sourced-scala.zip[here] +
(includes code from the previous step).

The completed source code for this section can be downloaded link:_attachments/3-shopping-cart-event-sourced-complete-scala.zip[here].
****
