...
. to use plain JDBC or Hibernate projections, use:
+
[source,diff]
.build.sbt
----
...
----
+
. to use Slick on your projections, use:
+
[source,diff]
.build.sbt
----
include::example$cleanup-dependencies-project/build.sbt[tag=replace-offset-store-for-projections-slick]
----
...
.build.sbt
----
include::example$cleanup-dependencies-project/build.sbt[tag=remove-akka-projection-test]
----
+
. Optionally, if you are not even querying the Akka Persistence Journal of events, you may even remove the Akka Persistence Query artifact:
+
[source,scala]
.build.sbt
----
include::example$cleanup-dependencies-project/build.sbt[tag=remove-akka-projection-optional]
----
