...
1. Start a local Cassandra server on default port 9042 and a Kafka broker on port 9094. The included `docker-compose.yml` starts everything required for running locally.
