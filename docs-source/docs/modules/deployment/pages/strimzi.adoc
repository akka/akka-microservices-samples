...
[source,shell script]
----
kubectl create secret generic shopping-cart-service-kafka-secret --from-literal=bootstrapServers=<bootstrap servers connect string>
----
