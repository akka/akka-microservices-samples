...
The Akka Cloud Platform is currently available for deploying on Amazon Elastic Kubernetes Service (EKS). It is available through the https://aws.amazon.com/marketplace/pp?sku=7hhouu843kzmgqs6besqjjsbf[Amazon Marketplace {tab-icon}, window="tab"] to install on your Amazon EKS cluster.
