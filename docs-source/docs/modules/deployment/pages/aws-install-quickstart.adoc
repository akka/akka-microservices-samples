...
A https://www.pulumi.com/docs/intro/concepts/stack/[Pulumi Stack {tab-icon}, window="tab"]  is an instance of the deployed Pulumi playbook and its associated state.
