...
To install Akka Cloud Platform in EKS, you need to perform the steps described on this page.
...
ifdef::review[REVIEWERS: this seems like a weird place to put the step to subscribe, I would put it in the prerequisites.]
