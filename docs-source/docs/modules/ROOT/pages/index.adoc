...
The xref:shopping-microservices:index.adoc[Akka Microservices tutorial] illustrates how to implement Event Sourcing with Akka Persistence and CQRS using Akka Projections.
