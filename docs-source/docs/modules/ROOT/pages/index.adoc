...
The tutorial shows how to build and run the services piece by piece:

include::microservices-tutorial:partial$listing.adoc[]

== Cloud deployment

The easiest way to deploy and manage Akka Microservices in Kubernetes is to use the Akka Platform Operator. The xref:deployment:index.adoc[Cloud deployment] section gives an overview of how the Kubernetes deployment with the Akka Platform Operator works.
