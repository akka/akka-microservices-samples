...
== Some key quick items
There are a few items that frequently need to be dealt with. The links and info below should help you access that information quickly.


=== Operator
Operator management is key. You will find details on xref:deployment:aws-install.adoc[installing]
...
Users often need information about TLS Certificates. You will find the pertinent information within the xref:deployment:aws-ingress.adoc#_tls_certificate[AWS LoadBalancer Controller] page.

=== Support
Support for the Akka Cloud Platform requires registration. https://aws.amazon.com/marketplace/pp/B08TLV16XM#pdp-support[Details] regarding support, and more, can be found on the AWS Marketplace.

== License expiration and renewal
If your Akka license expires without being renewed, your current application will continue to run, but you will no longer be able to deploy.

If you have acquired a term license, and it expires, your license will automatically revert into a pay-as-you-go license.

When you need to renew you license, please contact mailto:aws@lightbend.com[] with your request.
